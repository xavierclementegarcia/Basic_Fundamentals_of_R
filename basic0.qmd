...
En Rstudio van a escribir varios conjuntos de variables según el tipo de dato.
Tienen 5 minutos!
...
## Vectores {.smaller}
Digamos que estás haciendo un trabajo en botánica y quieres hacer un listado de especies de Asteraceae. <br> **¿Qué herramienta usas?** <br>
La lista, exacto...
```{r}
...
Elaborar un ejemplo de cada una de las estructuras de datos vistas en la clase. 
Tienen el resto del día!

# ¿Puedo acceder a estas presentaciones? {.smaller}

## ¿Cómo acceder a estas presentaciones? {.smaller}

Podrán encontrarlas en mi github page.<br> Pero no te adelantes y guarda calma. 
<br>
Si necesitas más información no dudes en escribirme: **xgarcia@unicauca.edu.co**
